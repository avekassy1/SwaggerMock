...
public class NumberSchemaPatternBuilderTest {
  ...
  @Autowired private NumberSchemaPatternBuilder builder;
  ...
  void shouldReturnMatchingPatternForEnumValues() {
    ...
    schema.setEnum(
        List.of(BigDecimal.valueOf(1.23), BigDecimal.valueOf(4.56), BigDecimal.valueOf(7.89)));
  ...
  void shouldEscapeSpecialCharactersInEnum() {
    NumberSchema schema = new NumberSchema();
    schema.setEnum(
        List.of(BigDecimal.valueOf(1.0), BigDecimal.valueOf(1.2), BigDecimal.valueOf(3.14)));
