...
public class StringResponseBodyExampleBuilder implements ResponseBodyExampleBuilder {
    ...
    public boolean supports(Schema<?> schema) {
        return schema instanceof StringSchema || (schema.getType() != null && schema.getType().equals("string"));
    }

    @Override
    public Object build(Schema<?> stringSchema) {
        return stringSchema.getExample() != null ?
            stringSchema.getExample() : EXAMPLE_STRING;
    }
